 ...
 *
 *  MODIFICATIONS:
 *  comment out IE6 stuff 1032, 1135, 1772-1836
 *  add font-icon 675
 *  modified base html 769-771
 *  location 1094 - 1128
 *  disabled icon placement line 710 - 761
 */
;(function($) {
    ...
    $.Zebra_DatePicker = function(element, options) {
        ...
        var init = function(update) {
            ...
            if (!plugin.settings.always_visible) {
                ...
                if (!update) {
                    ...
                    if (plugin.settings.show_icon) {
                        ...
                        var html = '<button type="button" class="Zebra_DatePicker_Icon' + ($element.attr('disabled') == 'disabled' ? ' Zebra_DatePicker_Icon_Disabled' : '') + '"><i class="font-icon-calendar iefix-icon"></i></button>';
            ...
            var html = '' +
                ...
                '<td class="dp_previous"><i class="font-icon-arrow-left iefix-icon"></i></td>' +
                '<td class="dp_next"><i class="font-icon-arrow-right iefix-icon"></i></td>' +
                '</tr>' +
                '</table>' +
